    ...
    stages {
        ...
        stage('Docker Build the Image') {
            steps {
                ...
                sh 'sudo docker build -t snapchat-raju-cicd-docker .'
            }
            post {
                success {
        ...
        stage('Docker Tag the Image') {
            steps {
                ...
                sh 'sudo docker tag snapchat-raju-cicd-docker 2004raju/snapchat-raju-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Docker Push the Image') {
            steps {
                ...
                sh 'sudo docker push 2004raju/snapchat-raju-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Cleanup Local Docker Images') {
            steps {
                ...
                sh '''
                    sudo docker rmi 2004raju/snapchat-raju-cicd-docker:latest
                    sudo docker rmi snapchat-raju-cicd-docker
                '''
            }
            post {
                success {
                    ...
                    if (containerExists) {
                        ...
                        if (userChoice == 'Yes') {
                            ...
                            sh '''
                                ...
                                sudo docker run -d -p 8084:8080 --name snapchat-container 2004raju/snapchat-raju-cicd-docker:latest
                            '''
                        } else {
                        ...
                        sh 'sudo docker run -d -p 8084:8080 --name snapchat-container 2004raju/snapchat-raju-cicd-docker:latest'
                    }
                }
            }
        }
